...
NAMESPACE=${NAMESPACE:-skuznetsov}
...
GRPC_JAVA_VERSION=${GRPC_JAVA_VERSION:-1.64}
GRPC_WEB_VERSION=${GRPC_WEB_VERSION:-1.5.0}
GRPC_GATEWAY_VERSION=${GRPC_GATEWAY_VERSION:-v2.20.0}
...
GO_ENVOYPROXY_PGV_VERSION=${GO_ENVOYPROXY_PGV_VERSION:-0.12.0}
GO_MWITKOW_GPV_VERSION=${GO_MWITKOW_GPV_VERSION:-0.3.2}
GO_PROTOC_GEN_GO_VERSION=${GO_PROTOC_GEN_GO_VERSION:-v1.34.2}
GO_PROTOC_GEN_GO_GRPC_VERSION=${GO_PROTOC_GEN_GO_GRPC_VERSION:-v1.5.4}
